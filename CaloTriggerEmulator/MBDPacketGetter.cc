...
MBDPacketGetter::MBDPacketGetter(const std::string &name)
  : SubsysReco(name)
...
//____________________________________________________________________________..
MBDPacketGetter::~MBDPacketGetter()
{

}

//____________________________________________________________________________..
int MBDPacketGetter::InitRun(PHCompositeNode *topNode)
{
...
//____________________________________________________________________________..
int MBDPacketGetter::process_event(PHCompositeNode *topNode)
{
...
void MBDPacketGetter::CreateNodeTree(PHCompositeNode *topNode)
{
